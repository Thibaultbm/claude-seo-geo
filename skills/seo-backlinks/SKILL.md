---
name: seo-backlinks
description: Plans and executes off-page SEO end to end, covering link building strategy, link profile review without paid tools, ninja linking (hands-on acquisition of links from profiles, forums, Q&A sites, directories, and communities), digital PR built on proprietary data, broken link building, linkable assets, and brand mention building for AI visibility (GEO). Use this skill whenever the user mentions backlinks, link building, netlinking, off-page SEO, domain authority or domain rating, link juice, anchor text, link velocity, guest posts, niche edits, broken links, unlinked brand mentions, disavow, toxic links, PBNs, digital PR, HARO, or link exchanges; asks how to get links, how to raise authority, or why competitors outrank them despite weaker content; or wants the brand cited more often in ChatGPT, Perplexity, or Google AI Overviews. Also use it to audit a backlink profile, design a 90-day link acquisition plan, or evaluate a single link opportunity. For local citations and NAP consistency, see the seo-local skill.
license: MIT
metadata:
