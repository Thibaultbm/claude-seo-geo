...
description: The fifth pillar in this repo, social content distribution and repurposing aimed strictly at SEO and GEO, driving branded search and feeding the third-party surfaces (YouTube, Reddit, LinkedIn) that AI engines cite. Turns one pillar asset into native posts per platform and prioritizes platforms by search and AI return over vanity reach. Use this skill whenever the user mentions social media for SEO, content distribution, content amplification, repurposing a blog post or pillar article, YouTube SEO, Reddit marketing, LinkedIn content, social signals, brand awareness for search, getting on Reddit or YouTube for AI visibility, appearing when people ask ChatGPT, or building an audience that supports rankings. Be eager to trigger; this work is under-served. For earning backlinks and brand mention placements, use the seo-backlinks skill. For which surfaces AI engines cite and passage citability, use the geo-visibility skill. For measuring social and AI traffic, use the geo-tracking skill.
license: MIT
metadata:
