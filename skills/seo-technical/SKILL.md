---
name: seo-technical
description: "Audits and fixes technical SEO: indexation, crawlability, robots.txt, sitemaps, IndexNow, Core Web Vitals, page speed, JavaScript rendering, AI crawler access, canonicals, hreflang, HTTPS, and site migrations. Canonical skill of this repository for AI crawler control and JS rendering: its references/ai-crawlers.md covers GPTBot, OAI-SearchBot, ChatGPT-User, ClaudeBot, PerplexityBot, Google-Extended, Bingbot, CCBot, with paste-ready robots.txt blocks and IP verification. Use this skill whenever the user mentions a technical SEO audit, a site or page not indexed, Core Web Vitals, LCP, INP, CLS, PageSpeed, slow pages, robots.txt, meta robots, noindex, sitemap issues, llms.txt, AI crawlers, GPTBot, content invisible to ChatGPT or Perplexity, server-side rendering, hreflang, duplicate content, a migration, redesign or domain change, or a hacked site. For structured data and JSON-LD, use the seo-schema-markup skill. For writing content that AI engines cite, use the geo-visibility skill."
license: MIT
metadata:
