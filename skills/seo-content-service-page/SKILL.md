...
description: Plans, writes, rewrites, and audits service pages and service-business landing pages, the money pages of agencies, consultants, trades, clinics, law firms, and SaaS. Applies a field-tested wireframe that ranks and converts (hero with CTA, social proof, benefits, numbered process, founder bio with real photo, 750+ word SEO text block, reviews, FAQ, final CTA), enforces one service = one page, sets title/H1/slug/meta patterns, benchmarks competitor depth, builds region and city pages for multi-area businesses, and adds a GEO layer so AI assistants recommend the business. Use this skill whenever the user works on a service page, landing page, agency or consultant site, a plumber, lawyer, dentist, electrician, or clinic website, an "our services" page, a lead generation page, a city or service-area page, or a one-page site that gets no organic leads. For blog articles, use the seo-content-blog skill. For Google Business Profile, reviews, and Maps, use the seo-local skill.
license: MIT
metadata:
