...
4. The only executable in the repository is `skills/seo-geo-audit/scripts/seo_audit.py`. It is pure Python standard library (Python 3.9+), no packages to install, no API keys.
